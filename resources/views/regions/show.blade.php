        ...
        <div class="mb-5 flex justify-between">
            ...
            <div class="grid md:grid-cols-2 md:gap-6 mb-4">
                <div class="relative z-0 w-full mb-5 group" style="margin-bottom: 0px;">
                    <h2 class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer font-mono ">region : {{ $region->name }}</h2>
                </div>
            </div>
            ...
            <table class="w-full text-md bg-gray-100 shadow border-gray-300 rounded mb-4">
                <tbody>
                    ...
                    <tr class="border-b hover:bg-orange-100 bg-gray-50">
                        ...
                        <td class="p-3 px-5">{{ $local->address }}</td>
                        <td class="p-3 px-5 flex justify-end">
                            <a href="/locals/{{ $local->id }}" class="mr-3 text-sm bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Voir</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
