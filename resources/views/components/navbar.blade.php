        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                <ul
                    ...
                    <x-navbar-link href="/" :active="request()->is('/')">Acceuil</x-navbar-link>
                    <x-navbar-link href="#" :active="request()->is('/dashboard')">Tableau de Bord</x-navbar-link>
                    <x-navbar-link href="#" :active="request()->is('/counter')">Compteurs</x-navbar-link>
                    <x-navbar-link href="#" :active="request()->is('/invoice')">Factures</x-navbar-link>
                    <x-navbar-link href="#" :active="request()->is('/controls')">Gestion</x-navbar-link>
                </ul>
            </div>
        </div>
    </nav>
