...
<x-layout>
    ...
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" style="margin-right: 2rem; margin-left: 2rem; margin-top:0.5rem;">
        ...
        <form method="GET" action="/users" class="">
            ...
            <!-- Search input -->
            <div class="mx-auto">
                <label for="serial_number" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
                <div class="relative">
                    ...
                    <input type="search" id="serial_number" name="serial_number" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Tapez le numéro de serie du compteur ici" />
                ...
                <tbody>
                    ...
                    @foreach ($users as $user)
                        <tr class="border-b hover:bg-orange-100 bg-gray-50">
                            ...
                            <td class="p-3 px-5">{{ $user->local->name }}</td>
